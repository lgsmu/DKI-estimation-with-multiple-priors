...
tic                      
[dt_22,fval_total_obj]=  fminlbfgs(@(x)fun_m1ncmnsslsspr_stationary(x,bvecmat,bmat,max(bval),im_r_w,im_r_w_square,sigma_map,Ncoils,Mask,lambda,temp4),x_initial,options); 
time_fitting = toc
 
   
%% scalar maps of DKI             
dt_22_ = reshape(dt_22,[nx,ny,22]);
b0 = exp(dt_22_(:,:,1));
dt_21 = dt_22_(:,:,2:22);     
...
clear dt_22_ dt_21 D_apprSq dt_21_
